    ...
    <div className="flex h-screen bg-gray-900 text-gray-300">
      ...
      <div className="w-64 bg-gray-800 p-6">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-sm">Math Teacher</p>
        </div>
      </div>
        ...
        <Card className="bg-gray-800">
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              <Button onClick={selectRandomStudents} size="sm" variant="secondary">
              ...
              {selectedClass !== "All" && (
                <Button onClick={() => setIsAddStudentDialogOpen(true)} size="sm" variant="secondary">
                  Add Student
                </Button>
              )}
            </div>
      ...
      <Dialog open={isAddStudentDialogOpen} onOpenChange={setIsAddStudentDialogOpen}>
        <DialogContent className="sm:max-w-[425px] bg-gray-800 text-gray-300">
          ...
          <Button onClick={handleAddStudent} variant="secondary">Add Student</Button>
        </DialogContent>
      </Dialog>
    </div>
  )
